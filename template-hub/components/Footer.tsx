        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5">
              ...
              <li>
                <a
                  href={mailLink("Demande d'information TemplateHub", "")}
                  className="inline-flex items-center gap-2 text-sm text-zinc-600 transition-colors hover:text-zinc-950"
                >
            ...
            <div className="mt-5 flex gap-3">
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full border border-zinc-200 bg-white text-zinc-600 transition-colors hover:border-zinc-300 hover:text-zinc-950"
              >
