...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-mist to-paper">
      ...
      />
      <div
        className="pointer-events-none absolute -left-32 top-64 h-72 w-72 rounded-full bg-accent-100/60 blur-3xl"
        aria-hidden="true"
      />
      ...
      <div className="relative mx-auto grid w-full max-w-7xl items-center gap-12 px-5 pb-16 pt-16 sm:px-8 sm:pb-20 sm:pt-20 lg:grid-cols-2 lg:gap-16 lg:pb-24">
        <div className="animate-fade-up">
          <p className="text-sm font-semibold uppercase tracking-widest text-brand-600">
            Centre de formation à {siteConfig.contact.city}
          </p>
          <h1 className="mt-4 max-w-2xl font-display text-4xl font-semibold leading-tight tracking-tight text-ink sm:text-5xl">
            Développez vos compétences avec une formation adaptée à vos
            objectifs
          </h1>
          <p className="mt-5 max-w-xl text-lg leading-relaxed text-zinc-600">
            Des programmes pratiques, un accompagnement personnalisé et des
            formateurs expérimentés pour progresser efficacement.
          </p>
        ...
        <div className="relative animate-fade-up">
          <div className="overflow-hidden rounded-[2rem] shadow-xl shadow-brand-900/10">
            <Image
              ...
              alt="Salle de formation avec des apprenants en séance"
              width={1200}
              height={1400}
