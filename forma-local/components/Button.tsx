...
/**
 * Bouton polyvalent : lien interne (`next/link`) par défaut, lien externe si
 * `external`, ou ancre simple `#…`. Pour un bouton de formulaire, utiliser un
 * `<button>` natif avec les classes de `buttonClassName`.
 */
